...
var stone_scene = preload("res://scenes/objects/rock/stone.tscn")

func _ready() -> void: 
	hurt_component.hurt.connect(on_hurt) 
	damage_component.max_damaged_reached.connect(on_max_damage_reach)
